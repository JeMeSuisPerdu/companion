    ...
    <div className="container py-5">
      <div className="mx-auto" style={{ maxWidth: '700px' }}>
        <div className="text-center mb-4">
          ...
          <h3 className="fw-bold">Inscription Entreprise</h3>
          <p className="text-muted">Rejoignez notre réseau d'entreprises inclusives</p>
        </div>

        <form onSubmit={handleSubmit} className="card shadow p-4">
          {/* Informations de compte */}
          <h5 className="fw-semibold mb-3">Informations de compte</h5>
          <div className="mb-3">
          ...
          <hr className="my-4" />
          <h5 className="fw-semibold mb-3">Informations de l'entreprise</h5>
          ...
          <div className="form-check my-3">
            <input
              ...
              required
            />
            <label className="form-check-label" htmlFor="terms-entreprise">
